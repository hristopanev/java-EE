...
import cookbook.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserServiceModel findUserIdByUsername(String username) {
        return this.modelMapper.map(this.userRepository.findUserIdByUsername(username), UserServiceModel.class);
    }
    ...
    public void deleteFollow(String user_id, String friend_id) {
        this.userRepository.deleteUserFriend(user_id, friend_id);
    }
}
